...
subtitle: "Computational workflow for the preprocessing of selected samples from of TCGA regarding Breast Cancer"
...
exit
```
### ii. Alignment and quantification of sequenced reads with STAR and Featurecounts
...
### v. __[FeatureCounts](http://subread.sourceforge.net/)__
```{r FeatureCounts}
library(Rsubread)
library(tidyverse)
