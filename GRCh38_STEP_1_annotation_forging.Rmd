...
STAR --genomeDir GRCh38_v34/ --genomeLoad LoadAndKeep \
...
--outFilterMatchNmin 16 --outFileNamePrefix "my_data/human_data/piRNABank/piBnk38_"
...
ambiguous_piRNAs <- complete_piBnk_RCent %>% 
  ...
  filter(duplicated(seq_id))# 1.055 ambiguous piRNA sequences from 27.963
