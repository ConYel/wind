...
Until now, we have prepared the files for annotation and quantification of 
smallRNA sequencing samples of human transcriptome. 
Afterwards, the steps in the pre-processing of the samples, alignment, quantification and calculation of transcript abundances should be followed.

## 4. Optional* Make the indexes for STAR and salmon with spike-in sequences
...
we will use fcat to make to fasta file, one of the genome and spike-ins and one of
...
# transriptome fasta
fcat my_data/human_data/sncRNA_piRNBnk_RNACent_GRCh38_v34.fa my_data/human_data/spike_ins.fasta > my_data/human_data/transcriptome_sncRNA_spike_ins_piRNBnk_RNACent_GRCh38_v34.fasta

# genome fasta
fcat my_data/human_data/GRCh38/GRCh38.primary_assembly.genome.fa my_data/human_data/spike_ins.fasta > my_data/human_data/genome_sncRNA_spike_ins_piRNBnk_RNACent_GRCh38_v34.fasta
```
...
grep "^>" my_data/human_data/genome_sncRNA_spike_ins_piRNBnk_RNACent_GRCh38_v34.fasta |cut -d " " -f 1 > my_data/human_data/decoys.txt

sed -i.bak -e 's/>//g' my_data/human_data/decoys.txt

fcat my_data/human_data/genome_sncRNA_spike_ins_piRNBnk_RNACent_GRCh38_v34.fasta  my_data/human_data/transcriptome_sncRNA_spike_ins_piRNBnk_RNACent_GRCh38_v34.fasta > my_data/human_data/gentrome_sncRNA_spike_ins_piRNBnk_RNACent_GRCh38_v34.fasta

pigz --best  my_data/human_data/gentrome_sncRNA_spike_ins_piRNBnk_RNACent_GRCh38_v34.fasta 

fcat my_data/human_data/GRCh38/GRCh38.primary_assembly.genome.fa  my_data/human_data/sncRNA_piRNBnk_RNACent_GRCh38_v34.fa > my_data/human_data/gentrome_sncRNA_piRNBnk_RNACent_GRCh38_v34.fasta

pigz --best  my_data/human_data/gentrome_sncRNA_piRNBnk_RNACent_GRCh38_v34.fasta 

mkdir GRCh38_v34_salmon
exit
# run the docker
docker run --rm -it -v $(pwd):/home/my_data combinelab/salmon
# create the index
## *remove manually the spike-ins chrs from decoys
salmon index -t my_data/human_data/gentrome_sncRNA_spike_ins_piRNBnk_RNACent_GRCh38_v34.fasta.gz -d my_data/human_data/decoys.txt -i my_data/human_data/GRCh38_v34_spike_ins_salmon/GRCh38_v34_spike_ins_index -k 15 -p 10
