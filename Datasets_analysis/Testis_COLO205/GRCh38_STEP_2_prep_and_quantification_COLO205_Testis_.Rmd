...
STAR --genomeDir my_data/human_data/GRCh38_v34_spike_ins_STAR/spike_GRCh38_v34 \
...
regex="${samp%%.trimmed.fastq.gz}";  
echo "Processing sample ${samp} start: $(date)";   
salmon quant -i my_data/human_data/GRCh38_v34_spike_ins_salmon/GRCh38_v34_spike_ins_index  \
-l A -r ${fn} --seqBias --gcBias --numBootstraps 100  -p 6 --validateMappings \
--writeMappings="${ANALYSIS_FOLDER}/quants/${regex}.sam" \
