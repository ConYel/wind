...
```
### ii. Plot the cpm of spike-ins in COLO205 before and after treatment

```{r plot of colo205 spike ins}
COLO205_plot <- CPM_COLO_fc_salmon %>%
  select(-c(source:sRNA_id2)) %>% 
...
magn_COLO_plot <-COLO205_plot + coord_cartesian(ylim = c(0, 3000)) 


pdf(file.path(dirname(dat_path[1]), "spike_ins_COLO205_treat_FC_salmon.pdf"))
COLO205_plot
magn_COLO_plot
dev.off()
```
