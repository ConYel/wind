...
subtitle: "Computational workflow for the preprocessing of adult mouse cardiomyocytes from the E-MTAB-9866 public dataset"
...
We will work on the datasets uploaded on ArrayExpress with id: [E-MTAB-9866](https://www.ebi.ac.uk/arrayexpress/experiments/E-MTAB-9866),
...
fastq-dl --cpus 4 --prefix "PRJEB41807" \
--outdir my_data/Datasets_analysis/mouse_CM/downloaded_samples PRJEB41807 ENA 
```
...
'fastqc' --threads 2 --outdir="${ANALYSIS_FOLDER}"/qc_before_trim \
...
'fastqc' --threads 2 --outdir="${ANALYSIS_FOLDER}"/qc_after_trim \
...
STAR --genomeDir my_data/mouse_data/indexes/GRCm38_v34 \
...
regex="${samp%%.trimmed.fastq.gz}";   
echo "Processing sample ${samp} start: $(date)";   
salmon quant -i my_data/mouse_data/indexes/GRCm38_v34_salmon  \
...
samtools view -O bam -o ${regex}.bam -@ 8 ${file};
echo "end:$(date)";
done
...
path_gtf <- file.path("mouse_data","sncRNA_piRNBnk_RNACent_GRCm38_v34.gtf")
...
fc %>% 
  write_rds(file = str_glue(file.path("Datasets_analysis", "mouse_CM",
