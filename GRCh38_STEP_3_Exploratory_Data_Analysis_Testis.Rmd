...
```{r}
annot_tbl %>% filter(gene_id == Testis_10_top_piRNA[1])
annot_tbl %>% filter(gene_id == COLO205_10_top_piRNA[1])
wh <- annot_tbl %>% filter(gene_id == COLO205_10_top_piRNA[1])
```
