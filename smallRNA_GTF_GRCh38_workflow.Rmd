...
```{r filter 100bp}
tr_sRNA <- sRNA %>% 
  as_tibble() %>% # [602,197] genomic ranges / [446,265] sRNA_ids
  ...
  distinct(seq_s, .keep_all = TRUE) %>% # remove dupl GRanges [160.980] -> [153.043] GRs / [44,529] -> [41,496] sRNA_ids
  separate(col = seq_s,
...
Afterwards, the steps on the _[GSM3535476_workflow.pdf](https://github.com/ConYel/genome_transc_human/blob/master/GSM3535476_workflow.pdf)_ should be followed to perform pre-processing of the samples, alignment, quantification and calculation of transcript abundances.
